...
$('#rsvp-form').on('submit', function (e) {
    ...
    if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
        ...
        $.post('https://script.google.com/macros/s/AKfycbwVoycy7mkYKfxcuzMsi2DiTd5_T9VSJsTI-vxIRR5XoWr7hLYdJZwZ2k_vOymwCpsM/exec', data)
            .done(function (data) {
                console.log(data);
...
function initMap() {
    ...
    var location = {lat: 40.11321870250692, lng: -74.93797124431974};
...
function initBBSRMap() {
    var la_fiesta = {lat: 40.11321870250692, lng: -74.93797124431974};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
